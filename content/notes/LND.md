...
LND connects to a Bitcoin backend for chain data, manages channel state, and exposes an API guarded by macaroon credentials and TLS. Applications like [[LNbits]] sit on top and expose friendlier interfaces.
